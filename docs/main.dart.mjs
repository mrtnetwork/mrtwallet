...
_1799: x0 => globalThis.workerListener_ = x0,
_1800: () => globalThis.workerListener_,
_1801: x0 => globalThis.errorListener_ = x0,
_1802: () => globalThis.errorListener_,
...
_1997: () => globalThis.localStorage,
_2001: (x0,x1) => x0.removeItem(x1),
_2004: x0 => globalThis.Object.entries(x0),
_2005: (x0,x1,x2) => ({data: x0,type: x1,additional: x2}),
_2006: x0 => x0.type,
_2007: (x0,x1) => x0.client_id = x1,
_2008: x0 => x0.client_id,
_2009: (x0,x1) => x0.request_id = x1,
_2010: x0 => x0.request_id,
_2011: x0 => x0.data,
_2012: x0 => x0.additional,
_2018: (x0,x1,x2,x3) => x0.sendMessage(x1,x2,x3),
_2020: (x0,x1) => x0.getURL(x1),
_2021: x0 => x0.id,
_2022: x0 => x0.id,
_2024: x0 => x0.onMessage,
_2026: x0 => x0.onConnect,
_2039: x0 => x0.onDisconnect,
_2040: x0 => x0.onMessage,
_2054: (x0,x1,x2) => x0.close(x1,x2),
_2055: x0 => x0.close(),
_2060: () => globalThis.window,
_2063: x0 => x0.BarcodeDetector,
_2064: x0 => x0.navigator,
_2067: x0 => x0.document,
_2070: (x0,x1) => x0.fetch(x1),
_2084: (x0,x1) => x0.createElement(x1),
_2085: x0 => x0.body,
_2087: x0 => globalThis.URL.createObjectURL(x0),
_2088: (x0,x1) => x0.appendChild(x1),
_2089: x0 => x0.click(),
_2090: (x0,x1) => x0.removeChild(x1),
_2092: x0 => x0.mediaDevices,
_2093: x0 => x0.userAgent,
_2094: (x0,x1,x2,x3,x4) => x0.share(x1,x2,x3,x4),
_2096: (x0,x1) => x0.getUserMedia(x1),
_2098: (x0,x1) => x0.detect(x1),
_2102: x0 => x0.rawValue,
_2115: (x0,x1) => new Blob(x0,x1),
_2119: x0 => x0.ok,
_2120: x0 => x0.status,
_2121: x0 => x0.arrayBuffer(),
_2122: x0 => x0.text(),
_2132: (x0,x1) => x0.type = x1,
_2149: x0 => x0.data,
_2150: (x0,x1,x2) => x0.addEventListener(x1,x2),
_2151: (x0,x1,x2) => x0.removeEventListener(x1,x2),
_2153: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._2153(f,arguments.length,x0) }),
_2165: (x0,x1) => new WebSocket(x0,x1),
_2166: x0 => x0.readyState,
_2168: (x0,x1) => x0.send(x1),
_2170: x0 => x0.local,
_2172: x0 => x0.session,
_2179: (x0,x1) => x0.get(x1),
_2182: (x0,x1) => x0.get(x1),
_2185: (x0,x1) => x0.remove(x1),
_2187: (x0,x1) => x0.remove(x1),
_2191: (x0,x1) => x0.set(x1),
_2196: (s, m) => {
          try {
...
_2197: (x0,x1) => x0.exec(x1),
_2198: (x0,x1) => x0.test(x1),
_2199: (x0,x1) => x0.exec(x1),
_2200: (x0,x1) => x0.exec(x1),
_2201: x0 => x0.pop(),
_2205: (x0,x1,x2) => x0[x1] = x2,
_2207: o => o === undefined,
_2208: o => typeof o === 'boolean',
_2209: o => typeof o === 'number',
_2211: o => typeof o === 'string',
_2214: o => o instanceof Int8Array,
_2215: o => o instanceof Uint8Array,
_2216: o => o instanceof Uint8ClampedArray,
_2217: o => o instanceof Int16Array,
_2218: o => o instanceof Uint16Array,
_2219: o => o instanceof Int32Array,
_2220: o => o instanceof Uint32Array,
_2221: o => o instanceof Float32Array,
_2222: o => o instanceof Float64Array,
_2223: o => o instanceof ArrayBuffer,
_2224: o => o instanceof DataView,
_2225: o => o instanceof Array,
_2226: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2228: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2229: o => o instanceof RegExp,
_2230: (l, r) => l === r,
_2231: o => o,
_2232: o => o,
_2233: o => o,
...
_2235: o => o.length,
_2238: (o, i) => o[i],
_2239: f => f.dartFunction,
_2240: l => arrayFromDartList(Int8Array, l),
_2241: (data, length) => {
...
_2242: l => arrayFromDartList(Uint8ClampedArray, l),
_2243: l => arrayFromDartList(Int16Array, l),
_2244: l => arrayFromDartList(Uint16Array, l),
_2245: l => arrayFromDartList(Int32Array, l),
_2246: l => arrayFromDartList(Uint32Array, l),
_2247: l => arrayFromDartList(Float32Array, l),
_2248: l => arrayFromDartList(Float64Array, l),
_2249: (data, length) => {
...
_2250: l => arrayFromDartList(Array, l),
_2251:       (s, length) => {
        if (length == 0) return '';
...
_2260: (o, p) => o[p],
_2261: (o, p, v) => o[p] = v,
_2262: (o, m, a) => o[m].apply(o, a),
_2264: o => String(o),
_2265: (p, s, f) => p.then(s, f),
_2266: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_2271: x0 => x0.length,
_2273: (x0,x1) => x0[x1],
_2274: (x0,x1) => x0.exec(x1),
_2276: x0 => x0.flags,
_2277: x0 => x0.multiline,
_2278: x0 => x0.ignoreCase,
_2279: x0 => x0.unicode,
_2280: x0 => x0.dotAll,
_2281: (x0,x1) => x0.lastIndex = x1,
...
_15188: x0 => x0.id,
_15189: (x0,x1) => x0.id = x1,
_15194: (x0,x1) => x0.autoplay = x1,
_15200: (x0,x1) => x0.href = x1,
_15201: (x0,x1) => x0.target = x1,
_15202: (x0,x1) => x0.download = x1,
_15206: (x0,x1) => x0.srcObject = x1,
_15220: x0 => x0.stop(),
_15222: x0 => x0.getTracks()
    };
