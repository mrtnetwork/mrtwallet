...
import 'package:mrt_wallet/models/wallet_models/network/custom/ton/ton.dart';
              ...
              body: Column(
                children: [
                  TextAndLinkView(
                    ...
                    url: AppLinkConst.tonMessageBodyReview,
                    linkDesc: "read_more".tr,
                  ),
                  WidgetConstant.height8,
                  TextAndLinkView(
                    text: "ton_bounce_desc".tr,
                    url: AppLinkConst.tonBouncableReview,
                    linkDesc: "read_more".tr,
                  )
                ],
              ),
