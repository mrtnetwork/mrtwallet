...
import 'package:mrt_wallet/future/pages/wallet_pages/network/ton/transaction/controller/controller.dart';
import 'package:mrt_wallet/future/pages/wallet_pages/network/ton/transaction/fields/token_list.dart';
...
class TonTransactionFieldsView extends StatelessWidget {
  ...
  final LiveTransactionValidator<TonTransactionValidator>? field;
  @override
...
class _TonTransactionsFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LiveWidget(() {
      final field = validator.value as TonTransferValidator;
...
class _TonTransactionTransferFields extends StatelessWidget {
  ...
  final TonTransactionStateController controller;
  final TonTransferValidator field;
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      onRemove: () {
                        context
                          ...
                          child: NumberWriteView(
                            ...
                            allowDecimal: false,
                            customValidator: field.queryIdValidator,
                            ...
                            title: PageTitleSubtitle(
                                ...
                                body: Column(
                                  ...
                                  children: [
                                    TextAndLinkView(
                                        text: "arbitrary_request_number".tr,
                                        url: AppLinkConst.reviewJettonQueryId),
                                  ],
                                )),
