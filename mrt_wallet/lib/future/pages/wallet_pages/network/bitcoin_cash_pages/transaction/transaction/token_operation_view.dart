...
class TokenCashOperationView extends StatefulWidget {
  ...
  final AppBitcoinCashNetwork network;
...
class _TokenCashOperationViewState extends State<TokenCashOperationView>
  ...
  late final NoneDecimalBalance remindTokenAmount;
  ...
  @override
  void initState() {
    remindAmount = NoneDecimalBalance(
        widget.remindAmount, widget.network.coinParam.decimal);
    remindTokenAmount =
        NoneDecimalBalance(token.cashToken.amount, widget.token.token.decimal!);
                                  ...
                                  onRemove: () {
                                    context
                                      ...
                                      child: SetupNetworkAmount(
                                        ...
                                        min: BitcoinCashUtils
                                            .minimumSatoshiTokenOutput,
