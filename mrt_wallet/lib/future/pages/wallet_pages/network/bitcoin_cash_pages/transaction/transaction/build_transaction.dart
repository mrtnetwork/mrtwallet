...
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_cash_pages/transaction/cotnroller/bitcoin_operation.dart';
...
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_cash_pages/transaction/transaction/token_builder.dart';
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_cash_pages/transaction/transaction/token_operation_view.dart';
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_cash_pages/widgets/cash_token_info.dart';
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_pages/controller/impl/transaction.dart';
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_pages/transaction/ordering/transaction_ordering_view.dart';
                      ...
                      controller.onUpdateOperations(
                          ...
                          (p0) async => context.openSliverBottomSheet<
                              ...
                              child: TokenCashOperationView(
                                ...
                                account: controller.account,
                                network:
                                    controller.network as AppBitcoinCashNetwork,
