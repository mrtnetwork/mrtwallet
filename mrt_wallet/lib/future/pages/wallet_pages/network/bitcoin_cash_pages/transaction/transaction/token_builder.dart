...
import 'package:mrt_wallet/future/pages/wallet_pages/network/bitcoin_cash_pages/transaction/global/bcmr_validate.dart';
import 'package:mrt_wallet/future/widgets/custom_widgets.dart';
import 'package:mrt_wallet/models/wallet_models/network/core/network.dart';
import 'package:mrt_wallet/models/wallet_models/network/custom/bitcoin_cash/cash_token_bcmr.dart';
import 'package:mrt_wallet/models/wallet_models/network/custom/bitcoin_cash/create_token_fields.dart';
import 'package:bitcoin_base/bitcoin_base.dart';
import 'package:mrt_wallet/models/wallet_models/network/transaction/bitcoin/bitcoin_utxos.dart';
...
class __BchCashTokenBuilderViewState extends State<BchCashTokenBuilderView>
  ...
  void setTotalSupply(BigRational? supply) {
    ...
    if (supply != null) {
      if (supply >= BitcoinCashUtils.minimumTokenCashTotalSupply &&
          supply <= BitcoinCashUtils.maximumTokenCashTotalSupply) {
        totalSupply = supply;
      }
    }
    _checkValidate();
  ...
  void onSetup() {
    if (!isReady) return;
    final token = BitcoinCashUtils.createCashToken(
  ...
  String? capabilityValidator(CashTokenCapability? capability) {
  ...
  String? commitmentValidate(String? v) {
    if (BitcoinCashUtils.commitmentValidate(v)) {
      return null;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              TextAndLinkView(
                  ...
                  url: AppLinkConst.reviewCashToken),
              WidgetConstant.height8,
              AppDropDownBottom(
                    ...
                    context
                        .openSliverBottomSheet<String>(
                          ...
                          child: StringWriterView(
                            ...
                            customValidator: commitmentValidate,
                      ...
                      .openSliverBottomSheet<BigRational>(
                        ...
                        child: NumberWriteView(
                          defaultValue: totalSupply ??
                              BitcoinCashUtils.minimumTokenCashTotalSupply,
                          allowDecimal: false,
                          max: BitcoinCashUtils.maximumTokenCashTotalSupply,
                          min: BitcoinCashUtils.minimumTokenCashTotalSupply,
                          allowSign: false,
                          title: PageTitleSubtitle(
              ...
              TextAndLinkView(
                  ...
                  url: AppLinkConst.cashTokensPCMRReview),
