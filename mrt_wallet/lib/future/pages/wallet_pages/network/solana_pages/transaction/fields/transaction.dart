...
class SolanaTransactionFieldsView extends StatelessWidget {
  ...
  final LiveTransactionValidator<SolanaTransactionValidator>? field;
  @override
...
class _CreateAssociatedTokenAccountFields extends StatelessWidget {
  ...
  final SolanaCreateAssociatedTokenAccountValidator field;
  final SolanaTransactionStateController controller;
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _CreateAccountFields extends StatelessWidget {
  ...
  final SolanaCreateAccountValidator field;
  final SolanaTransactionStateController controller;
  @override
  Widget build(BuildContext context) {
    return Column(
            ...
            context
                .openSliverBottomSheet<BigRational>(
                  ...
                  child: NumberWriteView(
                    ...
                    allowDecimal: false,
                    max: SolanaConstants.maximumAccountSizeBytes,
...
class _InitializeMintFields extends StatelessWidget {
  ...
  final SolanaInitializeMintValidator field;
  final SolanaTransactionStateController controller;
  @override
  Widget build(BuildContext context) {
    return Column(
          ...
          onRemove: () {
            context
              ...
              child: NumberWriteView(
                ...
                allowDecimal: false,
                max: SolanaConstants.maxSPLTokenDecimalPlaces,
                min: BigRational.zero,
                allowSign: false,
                title: PageTitleSubtitle(
                    title: "decimals".tr,
...
class _MintToFields extends StatelessWidget {
  ...
  final SolanaMintToValidator field;
  final SolanaTransactionStateController controller;
  @override
  Widget build(BuildContext context) {
    return Column(
