...
class RippleGlobalTransactionFieldsView extends StatelessWidget {
  const RippleGlobalTransactionFieldsView(
      ...
      super.key});
  final ValidatorField field;
  final CryptoAccountAddress address;
  final NetworkAccountCore account;
  final RippleTransactionValidator validator;
  @override
  Widget build(BuildContext context) {
    switch (field.id) {
      ...
      case "cancel_nft_nft_token_offers":
        final ValidatorField<List<String>> f =
            field as ValidatorField<List<String>>;
                ...
                return ContainerWithBorder(
                  ...
                  onRemove: () {
                    validator.removeIndex(
                        field as ValidatorField<List<String>>, index);
                  },
                ...
                onRemove: () {
                  context
                      ...
                      .then((value) => validator.setListValue(
                          field as ValidatorField<List<String>>, value));
                },
...
class _GenerateFulFillmentViewState extends State<_GenerateFulFillmentView>
  ...
  void generateFulFillment() async {
    ...
    if (fulFillment != null) {
      fulFillment = null;
      setState(() {});
      await MethodCaller.wait(milliseconds: 400);
    }
    progressKey.process();
    ...
    final result = await MethodCaller.call(() async {
      ...
      return fullFillment;
    }, delay: AppGlobalConst.oneSecoundDuration);
    if (result.hasError) {
      progressKey.error();
    } else {
