...
import 'package:mrt_wallet/future/pages/wallet_pages/network/cosmos/transaction/controller/controller.dart';
...
class CosmosTransactionFieldsView extends StatelessWidget {
  ...
  final LiveTransactionValidator<CosmosTransactionValidator>? field;
  @override
  Widget build(BuildContext context) {
    final LiveTransactionValidator<CosmosTransactionValidator> validator =
        field ?? context.getArgruments();
    return NetworkAccountControllerView<APPCosmosNetwork, ICosmosAddress>(
                                  ...
                                  context
                                      .openSliverBottomSheet<BigInt>(
                                        ...
                                        child: SetupNetworkAmount(
                                          ...
                                          max: controller.address.address
