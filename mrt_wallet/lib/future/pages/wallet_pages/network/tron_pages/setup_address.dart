...
class SetupTronAddressView extends StatefulWidget {
  const SetupTronAddressView({super.key});

  @override
  State<SetupTronAddressView> createState() => _SetupTronAddressViewState();
}

class _SetupTronAddressViewState extends State<SetupTronAddressView>
    with SafeState {
  ...
  APPTVMNetwork get network => networkAccounts.network as APPTVMNetwork;
  ...
  void generateAddress() async {
    ...
    final newAccount = TronNewAddressParam(coin: coin, deriveIndex: keyIndex);
