...
class EthereumWeb3AddEthereumChainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MrtViewBuilder<
            Web3EthereumGlobalRequestController<String,
                Web3EthereumAddNewChain>>(
        repositoryId: request.info.request.requestId,
        controller: () => Web3EthereumGlobalRequestController<String,
            Web3EthereumAddNewChain>(walletProvider: wallet, request: request),
        builder: (controller) {
