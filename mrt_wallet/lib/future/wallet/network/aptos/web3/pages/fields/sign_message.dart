...
class AptosWeb3SignMessageRequestView extends StatelessWidget {
  const AptosWeb3SignMessageRequestView({required this.request, super.key});
  final Web3AptosSignMessageForm request;
  Web3AptosSignMessage get param => request.request.params;
  @override
