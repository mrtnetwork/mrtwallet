...
import 'package:mrt_wallet/future/wallet/network/forms/aptos/forms/web3/forms/requst_account.dart';
import 'package:mrt_wallet/future/wallet/start/pages/account_not_adress.dart';
import 'package:mrt_wallet/future/widgets/custom_widgets.dart';

class AptosWeb3RequestAccountsView extends StatelessWidget {
  const AptosWeb3RequestAccountsView(
      {required this.field, required this.controller, super.key});
  final AptosRequestAccountForm field;
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Column(
            ...
            children: [
              Text("aptos_networks".tr, style: context.textTheme.titleMedium),
