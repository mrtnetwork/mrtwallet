...
class SubstrateWeb3SignMessageRequestView extends StatelessWidget {
  const SubstrateWeb3SignMessageRequestView({required this.request, super.key});
  final Web3SubstrateSignMessageForm<Web3SubstrateSignMessage> request;
  Web3SubstrateSignMessage get param => request.request.params;
  @override
