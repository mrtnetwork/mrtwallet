...
import 'package:mrt_wallet/future/wallet/network/sui/transaction/controller/controller/controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return NetworkAccountControllerView<SuiChain>(
        childBulder: (wallet, chain, switchAccount) {
          return MrtViewBuilder<SuiTransactionStateController>(
