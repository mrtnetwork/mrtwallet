...
class SuiWeb3SignMessageRequestView extends StatelessWidget {
  const SuiWeb3SignMessageRequestView({required this.request, super.key});
  final Web3SuiSignMessageForm request;
  Web3SuiSignMessage get param => request.request.params;
  @override
