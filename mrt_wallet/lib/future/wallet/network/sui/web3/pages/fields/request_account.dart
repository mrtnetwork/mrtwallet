...
import 'package:mrt_wallet/future/wallet/network/sui/web3/controller/controller.dart';
import 'package:mrt_wallet/future/wallet/start/pages/account_not_adress.dart';
import 'package:mrt_wallet/future/widgets/custom_widgets.dart';

class SuiWeb3RequestAccountsView extends StatelessWidget {
  const SuiWeb3RequestAccountsView(
      {required this.field, required this.controller, super.key});
  final SuiRequestAccountForm field;
      ...
      slivers: [
        SliverToBoxAdapter(
          child: Column(
            ...
            children: [
              Text("sui_networks".tr, style: context.textTheme.titleMedium),
