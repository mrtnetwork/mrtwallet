...
class CosmosWeb3SignMessageRequestView extends StatelessWidget {
  const CosmosWeb3SignMessageRequestView({required this.request, super.key});
  final Web3CosmosSignMessageForm request;
