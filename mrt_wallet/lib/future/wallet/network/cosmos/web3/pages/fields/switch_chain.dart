...
class CosmosWeb3SwitchChainView extends StatelessWidget {
  const CosmosWeb3SwitchChainView({required this.request, super.key});
  final Web3CosmosSwitchCosmosChain request;
  @override
