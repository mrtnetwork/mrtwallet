...
class BitcoinWeb3SwitchChainView extends StatelessWidget {
  const BitcoinWeb3SwitchChainView({required this.request, super.key});
  final Web3BitcoinSwitchBitcoinChain request;
  @override
