...
class AccessADALegacyPrivateKeyResponse implements AccessKeyResponse {
  ...
  const AccessADALegacyPrivateKeyResponse._(this.account, this.privateKey,
      this.extendedKey, this.coin, this.wif, this.keyName);
  factory AccessADALegacyPrivateKeyResponse.fromBip32(
    ...
    return AccessADALegacyPrivateKeyResponse._(
        account,
        account.privateKey.toHex(),
