...
class WalletMasterKeys with CborSerializable {
  ...
  WalletMasterKeys addKey(ImportedKeyStorage newKey) {
  ...
  factory WalletMasterKeys.fromCborBytesOrObject(
    ...
    try {
      final CborListValue cbor =
          CborSerializable.decodeCborTags(bytes, obj, CborTagsConst.mnemonic);
      ...
      return WalletMasterKeys._(
          Mnemonic.fromString(mnemonic),
          seed,
          List<ImportedKeyStorage>.unmodifiable(customKeys.value
