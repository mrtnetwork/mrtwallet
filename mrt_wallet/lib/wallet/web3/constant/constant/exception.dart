...
class Web3RequestExceptionConst {
  ...
  static Web3RequestException invalidHexBytes(String parameterName) =>
      Web3RequestException(
          message: "Invalid method parameters	",
          data:
              "Invalid hex bytes for $parameterName: Hex must be valid, start with '0x', and have an even length. Please check the input and try again.",
  ...
  static Web3RequestException invalidList(String parameterName) =>
      Web3RequestException(
          message: "Invalid method parameters	",
          data:
              "Invalid list argument provided for $parameterName. Please ensure the input is a valid list and try again.",
  ...
  static Web3RequestException invalidMap(String parameterName) =>
      Web3RequestException(
          message: "Invalid method parameters	",
          data:
              "Invalid map argument provided for $parameterName. Please ensure the input is a valid map and try again.",
