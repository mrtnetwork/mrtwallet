part of 'package:mrt_wallet/wroker/cross/web/web.dart';
...
class BrowserCryptoWorker extends IsolateCryptoWoker {
  ...
  Future<ByteBuffer> _loadWasm() async {
    ...
    // final wasmHash =
    //     BytesUtils.toHexString(QuickCrypto.sha3256Hash(file.asUint8List()));
...
//// https://nodejs.org/dist/latest-v16.x/docs/api/worker_threads.html#event-exit
