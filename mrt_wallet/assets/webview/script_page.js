...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    WalletEventTypes_fromName($name) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_1LE, new A.WalletEventTypes_fromName_closure($name), new A.WalletEventTypes_fromName_closure0($name));
    },
...
;
    ...
    B.List_1LE = A._setArrayType(makeConstList([B.WalletEventTypes_0, B.WalletEventTypes_1, B.WalletEventTypes_2, B.WalletEventTypes_3, B.WalletEventTypes_4, B.WalletEventTypes_5, B.WalletEventTypes_6, B.WalletEventTypes_7, B.WalletEventTypes_8]), A.findType("JSArray<WalletEventTypes>"));
