...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    CborUtils__toStringObject(utf8Bytes, tags) {
      ...
      else if (B.JSArray_methods.any$1(B.List_ww80, new A.CborUtils__toStringObject_closure(tags))) {
        baseType = B.JSArray_methods.firstWhere$1(B.List_ww80, new A.CborUtils__toStringObject_closure0(tags));
    ...
    EIP6963ProviderDetail_setup(ethereum) {
      ...
      A.print("\x1b[32meip6963 has been set\x1b[0m");
    },
    EthereumRequestParams_toWalletRequest(_this, requestId) {
      ...
      try {
        ...
        e = A.unwrapException(exception);
        A.print("\x1b[31m" + ("EthereumRequestParams ERROR " + A.S(e)) + "\x1b[0m");
        return null;
      }
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3 = new A.main_onActivation(new A._AsyncCompleter(t2, type$._AsyncCompleter_String));
              type$.JSObject._as(t1.window).addEventListener("MRT_ACTIVATION", A._functionToJS1(t3));
              t2.then$1$1(new A.main_closure(t3), type$.Null);
              A.print("\x1b[32mPage loaded.\x1b[0m");
              // implicit return
    ...
    EthereumEvnetTypes_fromTag(tag) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_ww8, new A.EthereumEvnetTypes_fromTag_closure(tag), new A.EthereumEvnetTypes_fromTag_closure0());
    },
    EthereumEvnetTypes_fromName($name) {
      var t1, exception;
      try {
        t1 = B.JSArray_methods.firstWhere$2$orElse(B.List_ww8, new A.EthereumEvnetTypes_fromName_closure($name), new A.EthereumEvnetTypes_fromName_closure0());
        return t1;
      } catch (exception) {
        return null;
      }
  ...
  A._CborDate.prototype = {
    ...
    get$hashCode(_) {
      ...
      return A.Object_hash(t1._core$_value, t1._microsecond);
    },
    $isCborObject: 1
  };
  ...
  A.EthereumJsController.prototype = {
    _parseRequestResponse$1(message) {
      ...
      switch (message.status) {
        case B.WalletRequestResponseType_List_50_success:
          A.print("\x1b[31mmessage done client received.\x1b[0m");
        ...
        case B.WalletRequestResponseType_List_51_failed:
          ...
          A.print("\x1b[31m" + ("error " + t2 + " " + A.S(t5)) + "\x1b[0m");
          t4 = t3.$index(0, t4);
          if (t4 != null) {
    ...
    _parseEvents$1(message) {
      ...
      switch (t1) {
        ...
        case B.EthereumEvnetTypes_List_100_accountsChanged:
          ...
          A.print("\x1b[31mselect account changed!\x1b[0m");
          break;
      }
      A.print("\x1b[32m" + ("on event " + t1._name) + "\x1b[0m");
    ...
    _postWalletEvent$1(params) {
      ...
      t3 = A._setArrayType([params.method, B.C_JsonCodec.encode$2$toEncodable(A.LinkedHashMap_LinkedHashMap$_literal(["result", params.params], type$.String, type$.dynamic), null), params.id], type$.JSArray_String);
      t4 = type$.JSObject;
      $event = t4._as(new t2(value, {bubbles: true, cancelable: false, detail: A.jsify(new A.CborTagValue(A.List_List$unmodifiable(A._setArrayType([100, 101], type$.JSArray_int), type$.int), new A.CborListValue(t3, true, type$.CborListValue_String), type$.CborTagValue_dynamic).encode$0())}));
      t4._as(t1.window).dispatchEvent($event);
    },
    _eventListeners$3$jsObject$object(type, jsObject, object) {
      ...
      try {
        ...
        A.print("\x1b[32m" + ("event was send: " + t2 + " " + t3 + " " + A.S(t5)) + "\x1b[0m");
        t4 = t4.$index(0, type);
        t4.toString;
        ...
        e = A.unwrapException(exception);
        A.print("\x1b[31m" + ("got error " + A.S(e) + " " + type.toString$0(0) + " " + A.S(jsObject)) + "\x1b[0m");
      }
    },
  ...
  A.EthereumJsController_onEvent_closure0.prototype = {
    call$1(e) {
      A.print("\x1b[31m" + ("has error onEvent " + A.S(e)) + "\x1b[0m");
    },
    $signature: 2
  };
  ...
  A.main_onActivation.prototype = {
    call$1(data) {
      ...
      if (A.EventInit_detailBytes(data) == null)
        return;
      ...
      if ($event.status === B.WalletRequestResponseType_List_51_failed) {
        this.completer.completeError$1(A.MRTWalletError_constructor_fromJson(type$.Map_String_dynamic._as($event.data)));
        return;
      }
      this.completer.complete$1(A._asString($event.data));
    },
    $signature: 13
  };
  A.main_closure.prototype = {
    call$1(e) {
      var t1, t2, t3, controller, t4, t5, t6, _this, eth, value;
      A._asString(e);
      t1 = self;
      t2 = type$.JSObject;
      ...
      t3 = A._functionToJS1(controller.get$onEthereumRequest());
      t4 = A._functionToJS2(controller.get$onEvent());
      t5 = A._functionToJS2(controller.get$removeEvent());
      A._functionToJS0(controller.get$disconnect());
      t6 = A._functionToJS0(controller.get$enable());
      _this = {};
      _this.request = t3;
      _this.on = t4;
      _this.removeListener = t5;
      _this.providerInfo = $.$get$EIP6963ProviderInfo__providerInfo();
      _this.enable = t6;
      _this.isMetaMask = true;
      eth = t2._as(t1.Object.freeze(_this));
      A.EIP6963ProviderDetail_setup(_this);
      t2._as(t1.MRT).ethereum = eth;
      t1.ethereum = eth;
      t1 = t2._as(t1.window);
      value = controller.__EthereumJsController__id_FI;
      if (value === $) {
        value !== $ && A.throwLateFieldADI("_id");
        value = controller.__EthereumJsController__id_FI = "ETH_" + e;
      }
      t1.addEventListener(value, A._functionToJS1(controller.get$_onWalletEvent()));
      A.print("\x1b[32m" + ("Page has been activated with client id: " + e + " " + e) + "\x1b[0m");
    },
    $signature: 33
  };
...
;
    ...
    B.List_ww80 = A._setArrayType(makeConstList([B.CborBase64Types_List_34, B.CborBase64Types_List_33, B.CborBase64Types_List_21, B.CborBase64Types_List_22, B.CborBase64Types_List_23]), A.findType("JSArray<CborBase64Types>"));
    B.List_ww8 = A._setArrayType(makeConstList([B.EthereumEvnetTypes_List_100_accountsChanged, B.EthereumEvnetTypes_List_101_chainChanged, B.EthereumEvnetTypes_List_102_message, B.EthereumEvnetTypes_List_103_connect, B.EthereumEvnetTypes_List_104_disconnect]), A.findType("JSArray<EthereumEvnetTypes>"));
